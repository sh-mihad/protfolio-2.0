...
const Navbar = () => {
    return (
        ...
        <div class="bg-[#0a192f] flex justify-between px-2 lg:px-10 py-3   sticky top-0 z-40">
            <div>
                <a href="#home"><img src={logo}  className="lg:h-12 lg:w-12  h-7 w-7" alt="" /></a>
            </div>

            <div className="text-[#ccd6f6] text-xs lg:flex lg:gap-7  my-2 lg:text-sm mono-font  ">
                <a class="hover:text-[#5ff3d1]" href="#about"><span className="mx-0 lg:mx-1 text-[#5ff3d1]">01.</span> About</a>
